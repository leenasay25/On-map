...
class UdacityClient: NSObject {
    ...
    class func login(email: String, password: String, completion: @escaping (Bool, Error?) -> Void) {
        ...
        RequestHelpers.taskForPOSTRequest(url: Endpoints.udacityLogin.url, apiType: "Udacity", responseType: loginResponse.self, body: body, httpMethod: "POST") { (response, error) in
            ...
            if let response = response {
                ...
                getLogged(completion: { (success, error) in
                    if success {
    ...
    class func getLogged(completion: @escaping (Bool, Error?) -> Void) {
        RequestHelpers.taskForGETRequest(url: Endpoints.getLoggedInUserProfile.url, apiType: "Udacity", responseType: User.self) { (response, error) in
            if let response = response {
